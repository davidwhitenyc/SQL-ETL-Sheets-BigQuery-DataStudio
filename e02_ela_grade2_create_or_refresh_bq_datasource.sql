...
----import grade 2 ela: heggerty data (all assessments)----
...
SELECT *
FROM `harlemlinksy2122.trackers.ela_heggerty_grade2_assessment2`;
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_reading_grade2_unit1` UNPIVOT(points_earned FOR question_id IN (
   reading_grade2_unit1_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_writing_grade2_unit1` UNPIVOT(points_earned FOR question_id IN (
   writing_grade2_unit1_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_fundations_grade2_assessment1` UNPIVOT(points_earned FOR question_id IN (
   fundations_grade2_assessment1_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_fundations_grade2_assessment2` UNPIVOT(points_earned FOR question_id IN (
   fundations_grade2_assessment2_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_heggerty_grade2_assessment1` UNPIVOT(points_earned FOR question_id IN (
   heggerty_grade2_assessment1_01,
...
--unpivot ela: heggerty grade 2 assessment #2
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.ela_heggerty_grade2_assessment2` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_heggerty_grade2_assessment2` UNPIVOT(points_earned FOR question_id IN (
   heggerty_grade2_assessment2_01,
   heggerty_grade2_assessment2_02,
   heggerty_grade2_assessment2_03,
   heggerty_grade2_assessment2_04,
   heggerty_grade2_assessment2_05,
   heggerty_grade2_assessment2_06,
   heggerty_grade2_assessment2_07,
   heggerty_grade2_assessment2_08
...
--pull unpivoted data from ela: heggerty grade 2 assessment 2
UNION ALL
SELECT
  osis,
  question_id,
  points_earned,
FROM
`harlemlinksy2122.unpivots.ela_heggerty_grade2_assessment2`
--insert UNION ALL code block here for the next assessment
