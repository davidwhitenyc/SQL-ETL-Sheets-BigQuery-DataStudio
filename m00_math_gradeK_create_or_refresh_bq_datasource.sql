...
--import grade k math unit 2 data
SELECT *
FROM `harlemlinksy2122.trackers.math_gradek_unit2`;


--import grade k math unit 3 data
SELECT *
FROM `harlemlinksy2122.trackers.math_gradek_unit3`;


--import grade k math unit 4 data
SELECT *
FROM `harlemlinksy2122.trackers.math_gradek_unit4`;
...
--unpivot math grade k unit 2 data
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.math_gradek_unit2` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.math_gradek_unit2` UNPIVOT(points_earned FOR question_id IN (math_gradek_unit2_q01,
math_gradek_unit2_q02,
math_gradek_unit2_q03,
math_gradek_unit2_q04,
math_gradek_unit2_q05,
math_gradek_unit2_q06,
math_gradek_unit2_q07,
math_gradek_unit2_q08,
math_gradek_unit2_q09,
math_gradek_unit2_q10,
math_gradek_unit2_q11,
math_gradek_unit2_q12,
math_gradek_unit2_q13,
math_gradek_unit2_q14,
math_gradek_unit2_q15,
math_gradek_unit2_q16,
math_gradek_unit2_q17

      )) ;

--unpivot math grade k unit 3 data
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.math_gradek_unit3` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.math_gradek_unit3` UNPIVOT(points_earned FOR question_id IN (
math_gradek_unit3_q01,
math_gradek_unit3_q02,
math_gradek_unit3_q03,
math_gradek_unit3_q04,
math_gradek_unit3_q05,
math_gradek_unit3_q06,
math_gradek_unit3_q07,
math_gradek_unit3_q08,
math_gradek_unit3_q09,
math_gradek_unit3_q10

      )) ;


--unpivot math grade k unit 4 data
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.math_gradek_unit4` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.math_gradek_unit4` UNPIVOT(points_earned FOR question_id IN (
math_gradek_unit4_q01,
math_gradek_unit4_q02,
math_gradek_unit4_q03,
math_gradek_unit4_q04,
math_gradek_unit4_q05,
math_gradek_unit4_q06,
math_gradek_unit4_q07,
math_gradek_unit4_q08,
math_gradek_unit4_q09,
math_gradek_unit4_q10,
math_gradek_unit4_q11,
math_gradek_unit4_q12,
math_gradek_unit4_q13,
math_gradek_unit4_q14,
math_gradek_unit4_q15
...
--pull unpivoted data from math grade k unit 2
UNION ALL
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.unpivots.math_gradek_unit2`
--pull unpivoted data from math grade k unit 3
UNION ALL
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.unpivots.math_gradek_unit3`
--pull unpivoted data from math grade k unit 4
UNION ALL
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.unpivots.math_gradek_unit4`
...
--pull in qualitative data from post-baseline units
  unit1_count_as_high_as_you_can,
  unit2_count_as_high_as_you_can,
  unit3_count_as_high_as_you_can,
  unit4_count_as_high_as_you_can,
  raw_unit1_count_as_high_as_you_can,
  raw_unit2_count_as_high_as_you_can,
  raw_unit3_count_as_high_as_you_can,
  raw_unit4_count_as_high_as_you_can
...
LEFT JOIN
  `harlemlinksy2122.trackers.math_gradek_unit2` unit2

ON results.osis = unit2.osis

LEFT JOIN
  `harlemlinksy2122.trackers.math_gradek_unit3` unit3

ON results.osis = unit3.osis


LEFT JOIN
  `harlemlinksy2122.trackers.math_gradek_unit4` unit4

ON results.osis = unit4.osis

WHERE results.osis IS NOT NULL

--insert LEFT JOIN for the next unit here
;
