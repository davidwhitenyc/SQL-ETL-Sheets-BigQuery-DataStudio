...
SELECT *
FROM `harlemlinksy2122.trackers.ela_heggerty_gradek_assessment2`;
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_reading_gradek_unit1` UNPIVOT(points_earned FOR question_id IN (
   reading_gradek_unit1_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_reading_gradek_unit2` UNPIVOT(points_earned FOR question_id IN (
   reading_gradek_unit2_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_writing_gradek_baseline` UNPIVOT(points_earned FOR question_id IN (
   writing_gradek_baseline_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_fundations_gradek_assessment1` UNPIVOT(points_earned FOR question_id IN (
   fundations_gradek_assessment1_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_heggerty_gradek_baseline` UNPIVOT(points_earned FOR question_id IN (
   heggerty_gradek_baseline_01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_heggerty_gradek_assessment1` UNPIVOT(points_earned FOR question_id IN (
   heggerty_gradek_assessment1_01,
...
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.ela_heggerty_gradek_assessment2` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_heggerty_gradek_assessment2` UNPIVOT(points_earned FOR question_id IN (
   heggerty_gradek_assessment2_01,
   heggerty_gradek_assessment2_02,
   heggerty_gradek_assessment2_03,
   heggerty_gradek_assessment2_04,
   heggerty_gradek_assessment2_05,
   heggerty_gradek_assessment2_06,
   heggerty_gradek_assessment2_07,
   heggerty_gradek_assessment2_08
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_uppercase_letters_gradek_baseline` UNPIVOT(points_earned FOR question_id IN (
   letter_recognition_uppercase_baseline_H,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_uppercase_letters_gradek_winter` UNPIVOT(points_earned FOR question_id IN (
   letter_recognition_uppercase_winter_H,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_lowercase_letters_gradek_baseline` UNPIVOT(points_earned FOR question_id IN (
   letter_recognition_lowercase_baseline_h,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_lowercase_letters_gradek_winter` UNPIVOT(points_earned FOR question_id IN (
   letter_recognition_lowercase_winter_h,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_letter_sounds_gradek_baseline` UNPIVOT(points_earned FOR question_id IN (
   letter_sounds_baseline_h,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_letter_sounds_gradek_winter` UNPIVOT(points_earned FOR question_id IN (
   letter_sounds_winter_h,
...
--pull unpivoted data from ela: heggerty grade k assessment 2
UNION ALL
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.unpivots.ela_heggerty_gradek_assessment2` 
--insert UNION ALL code block here for the next assessment
