-----------------------------------------------------------------------------
--run this combined script to refresh the Math Grade 3 BigQuery Datasource---
-----------------------------------------------------------------------------


--[step 01.1] import data from classroom trackers

--import grade 3 math baseline data
SELECT *
FROM `harlemlinksy2122.trackers.math_grade3_baseline`;


--import grade 3 math unit 1 data
SELECT *
FROM `harlemlinksy2122.trackers.math_grade3_unit1`;


--import grade 3 math unit 2 data
SELECT *
...
--import grade 3 math unit 5 data
SELECT *
FROM `harlemlinksy2122.trackers.math_grade3_unit5`;


--import grade 3 math unit 6 data
SELECT *
FROM `harlemlinksy2122.trackers.math_grade3_unit6`;
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade3_baseline` UNPIVOT(points_earned FOR question_id IN (
math_grade3_baseline_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade3_unit1` UNPIVOT(points_earned FOR question_id IN (
math_grade3_unit1_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade3_unit2` UNPIVOT(points_earned FOR question_id IN (
math_grade3_unit2_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade3_unit3` UNPIVOT(points_earned FOR question_id IN (
math_grade3_unit3_q01,
...
--unpivot math grade 3 unit 5 data
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.math_grade3_unit5` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade3_unit5` UNPIVOT(points_earned FOR question_id IN (
math_grade3_unit5_q01,
math_grade3_unit5_q02,
math_grade3_unit5_q03,
math_grade3_unit5_q04,
math_grade3_unit5_q05,
math_grade3_unit5_q06,
math_grade3_unit5_q07,
math_grade3_unit5_q08,
math_grade3_unit5_q09,
math_grade3_unit5_q10,
math_grade3_unit5_q11,
math_grade3_unit5_q12
...
--unpivot math grade 3 unit 6 data
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.math_grade3_unit6` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade3_unit6` UNPIVOT(points_earned FOR question_id IN (
math_grade3_unit6_q01,
math_grade3_unit6_q02,
math_grade3_unit6_q03,
math_grade3_unit6_q04,
math_grade3_unit6_q05,
math_grade3_unit6_q06,
math_grade3_unit6_q07,
math_grade3_unit6_q08,
math_grade3_unit6_q09,
math_grade3_unit6_q10,
math_grade3_unit6_q11
...
--pull unpivoted data from math grade 3 unit 5
UNION ALL
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.unpivots.math_grade3_unit5` 
--pull unpivoted data from math grade 3 unit 6
UNION ALL
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.unpivots.math_grade3_unit6` 
...
--the results is used to calculate benchmarks grouped by students.osis and questions.unit
  `harlemlinksy2122.results.math_grade3` AS
SELECT
  unions.osis,
  unions.question_id,
--pulls in columns for questions.points_available and questions.unit
  ...
  points_available
FROM
  `harlemlinksy2122.unions.math_grade3` unions
LEFT JOIN
