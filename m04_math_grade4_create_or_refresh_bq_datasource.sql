-----------------------------------------------------------------------------
--run this combined script to refresh the Math Grade 4 BigQuery Datasource---
-----------------------------------------------------------------------------


--[step 01.1] import data from classroom trackers

--import grade 4 math baseline data
SELECT *
FROM `harlemlinksy2122.trackers.math_grade4_baseline`;


--import grade 4 math unit 1 data
SELECT *
FROM `harlemlinksy2122.trackers.math_grade4_unit1`;


--import grade 4 math unit 2 data
SELECT *
...
--import grade 4 math unit 5 data

SELECT *
FROM `harlemlinksy2122.trackers.math_grade4_unit5`;


--import grade 4 math unit 6 data

SELECT *
FROM `harlemlinksy2122.trackers.math_grade4_unit6`;
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade4_baseline` UNPIVOT(points_earned FOR question_id IN (
math_grade4_baseline_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade4_unit1` UNPIVOT(points_earned FOR question_id IN (
math_grade4_unit1_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade4_unit2` UNPIVOT(points_earned FOR question_id IN (
math_grade4_unit2_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade4_unit3` UNPIVOT(points_earned FOR question_id IN (
math_grade4_unit3_q01,
...
--unpivot math grade 4 unit 5 data
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.math_grade4_unit5` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade4_unit5` UNPIVOT(points_earned FOR question_id IN (
math_grade4_unit5_q01,
math_grade4_unit5_q02,
math_grade4_unit5_q03,
math_grade4_unit5_q04,
math_grade4_unit5_q05,
math_grade4_unit5_q06,
math_grade4_unit5_q07,
math_grade4_unit5_q08,
math_grade4_unit5_q09,
math_grade4_unit5_q10,
math_grade4_unit5_q11
...
--unpivot math grade 4 unit 6 data
CREATE OR REPLACE TABLE
  `harlemlinksy2122.unpivots.math_grade4_unit6` AS
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.trackers.math_grade4_unit6` UNPIVOT(points_earned FOR question_id IN (
math_grade4_unit6_q01,
math_grade4_unit6_q02,
math_grade4_unit6_q03,
math_grade4_unit6_q04,
math_grade4_unit6_q05,
math_grade4_unit6_q06,
math_grade4_unit6_q07,
math_grade4_unit6_q08,
math_grade4_unit6_q09,
math_grade4_unit6_q10
...
--pull unpivoted data from math grade 4 unit 5
UNION ALL
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.unpivots.math_grade4_unit5` 


--pull unpivoted data from math grade 4 unit 6
UNION ALL
SELECT
  osis,
  question_id,
  points_earned
FROM
  `harlemlinksy2122.unpivots.math_grade4_unit6` 
...
--the results is used to calculate benchmarks grouped by students.osis and questions.unit
  `harlemlinksy2122.results.math_grade4` AS
SELECT
  unions.osis,
  unions.question_id,
--pulls in columns for questions.points_available and questions.unit
  ...
  points_available
FROM
  `harlemlinksy2122.unions.math_grade4` unions
LEFT JOIN
...
CREATE OR REPLACE TABLE
  `harlemlinksy2122.benchmarks.math_grade4` AS
SELECT
  osis,
  unit,
...
END
  AS math_benchmark
FROM
  `harlemlinksy2122.results.math_grade4`
WHERE
  osis IS NOT NULL
GROUP BY
  1,
...
--it serves as the datasouse for the math level 3 grade 4 dashboard

CREATE OR REPLACE TABLE
  `harlemlinksy2122.datasources.math_grade4` AS
...
FROM
  `harlemlinksy2122.results.math_grade4` results
...
LEFT JOIN
`harlemlinksy2122.benchmarks.math_grade4` benchmarks
