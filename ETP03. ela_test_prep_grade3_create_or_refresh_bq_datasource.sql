...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_test_prep_grade3_quiz_2_1` UNPIVOT(points_earned FOR question_id IN (test_prep_ela_grade3_quiz_2_1_q01,
...
SELECT
  ...
  student_answer
FROM
  `harlemlinksy2122.trackers.ela_test_prep_grade3_quiz_2_1` UNPIVOT(student_answer FOR question_id IN (response_test_prep_ela_grade3_quiz_2_1_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_test_prep_grade3_quiz_2_2` UNPIVOT(points_earned FOR question_id IN (test_prep_ela_grade3_quiz_2_2_q01,
...
SELECT
  ...
  student_answer
FROM
  `harlemlinksy2122.trackers.ela_test_prep_grade3_quiz_2_2` UNPIVOT(student_answer FOR question_id IN (response_test_prep_ela_grade3_quiz_2_2_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_test_prep_grade3_quiz_2_3` UNPIVOT(points_earned FOR question_id IN (test_prep_ela_grade3_quiz_2_3_q01,
...
SELECT
  ...
  student_answer
FROM
  `harlemlinksy2122.trackers.ela_test_prep_grade3_quiz_2_3` UNPIVOT(student_answer FOR question_id IN (response_test_prep_ela_grade3_quiz_2_3_q01,
...
SELECT
  ...
  points_earned
FROM
  `harlemlinksy2122.trackers.ela_test_prep_grade3_quiz_2_4` UNPIVOT(points_earned FOR question_id IN (test_prep_ela_grade3_quiz_2_4_q01,
...
SELECT
  ...
  student_answer
FROM
  `harlemlinksy2122.trackers.ela_test_prep_grade3_quiz_2_4` UNPIVOT(student_answer FOR question_id IN (response_test_prep_ela_grade3_quiz_2_4_q01,
